...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.mlp_U_lr_init = 0.002
        self.mlp_U_lr_final = 0.00002  
        self.mlp_U_lr_delay_mult = 0.01
        self.mlp_U_lr_max_steps = 30_000

        self.mlp_V_lr_init = 0.002
        self.mlp_V_lr_final = 0.00002  
        self.mlp_V_lr_delay_mult = 0.01
        self.mlp_V_lr_max_steps = 30_000

        self.gain_lr_init = 0.0005
        self.gain_lr_final = 0.00001  
        self.gain_lr_delay_mult = 0.01
        self.gain_lr_max_steps = 30_000
