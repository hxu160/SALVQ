...
def generate_neural_gaussians(viewpoint_camera, pc : GaussianModel, visible_mask=None, is_training=False, step=0):
    ...
    if is_training:
        ...
        if step > 10000:
            ...
            bit_feat = pc.entropy_gaussian.forward(feat_chosen, torch.zeros_like(feat_chosen), scale, Q_feat)
        ...
        feat = (STE_multistep.apply(feat, Q_feat)).detach()
